...
import { BookOpen, Calendar, Users, ArrowUpRight, GraduationCap } from 'lucide-react';
  ...
  return (
    <section id="programs" className="relative py-8 bg-transparent border-none overflow-hidden md:py-12">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 select-none">
        ...
        <div className="flex flex-nowrap overflow-x-auto scrollbar-none pb-4 lg:pb-0 lg:flex-wrap justify-start lg:justify-center gap-3 mb-10 sm:mb-12 select-none max-w-4xl mx-auto px-4 -mx-4 md:px-0 md:mx-auto">
          {categories.map((cat) => {
              ...
              <button
                ...
                className={`px-6 py-3 rounded-2xl font-mono text-[10px] sm:text-[11px] font-black uppercase tracking-[0.2em] border transition-all duration-500 cursor-pointer relative overflow-hidden group shrink-0 ${
                  isActive 
                    ...
                    : 'liquid-glass text-slate-500 hover:text-[#0A192F] hover:border-slate-300 shadow-sm'
                }`}
              >
          ...
          <AnimatePresence mode="popLayout">
            {filteredPrograms.map((prog, index) => (
              <motion.div
                ...
                className="group relative liquid-glass rounded-3xl p-8 sm:p-10 flex flex-col justify-between hover:shadow-[0_30px_60px_-15px_rgba(10,25,47,0.08)] hover:border-[#C5A059]/30 transition-shadow duration-500 h-full overflow-hidden"
              >
                ...
                <div className="relative z-10">
                  ...
                  {/* Program Description */}
                  <p className="text-slate-500 text-sm font-light leading-relaxed mb-8 opacity-90 group-hover:opacity-100 transition-opacity duration-700">
                    {prog.description}
                  </p>
                </div>
                ...
                <div className="relative z-10 space-y-5 pt-6 mt-auto">
                  ...
                  <button
                    ...
                    className="flex items-center justify-center gap-2 w-full py-3.5 rounded-xl border border-slate-200 bg-white text-[#0A192F] hover:bg-slate-900 hover:text-[#C5A059] hover:border-slate-900 transition-all duration-300 cursor-pointer text-[9px] font-mono font-black uppercase tracking-[0.2em] group/btn shadow-sm hover:shadow-lg"
                  >
